...
mcp = FastMCP(
    "neuraltree",
    description="Universal Neural Organization MCP Server — filesystem scanning, "
    "reference tracing, scoring, wiring, and sandbox virtualization.",
)
